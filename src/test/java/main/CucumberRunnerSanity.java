...
@CucumberOptions(strict = true, monochrome = true, features = "src/test/resources/SanitySuite", glue = "stepdefinition", format = {"pretty","json:target/cucumber.json"}, tags = { "@Regression,@JunitScenario,@TestngScenario" })

public class CucumberRunnerSanity extends AbstractTestNGCucumberTests {
